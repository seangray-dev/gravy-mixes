      ...
      <div className='bg-white py-20 px-8 md:grid justify-center items-center'>
        <div className='grid gap-4 md:max-w-[387px]'>
          ...
          <p className='opacity-60 text-sm tracking-wide'>
            ...
            placements on numerous popular playlists. Explore the top playlists
            showcasing our work and see for yourself the transformative sonic
            impact we can bring to your project.
          </p>
        </div>
      </div>
